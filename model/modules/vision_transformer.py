...
#         x_mask = torch.cat([torch.ones(x_mask.shape[0], 1).to(x_mask), x_mask], dim=1)
    ...
    def forward(self, x, x_mask, text_embeds=None, text_masks=None, image_embeds=None, image_masks=None, video_embeds=None, video_masks=None, ori_shape=None):
