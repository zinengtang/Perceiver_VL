python run.py with data_root='/playpen/terran/pretraining_bin/' gpus=4 num_nodes=1 task_mlm_vtm_mpp step200k \
per_gpu_batchsize=8 model_type='PerceiverVL' learning_rate=3e-4 \
